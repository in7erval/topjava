...
public class UserMealsUtil {
	...
	public static List<MealTo> filteredByCycles(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
		...
		meals.forEach(meal -> {
		    ...
		    if (TimeUtil.isBetweenHalfOpen(localTime, startTime, endTime)) {
                ...
                MealTo userMealWithExcess = new MealTo(meal.getId(), meal.getDateTime(),
	...
	public static List<MealTo> filteredByStreams(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
		...
		return meals
					...
					.map(x -> new MealTo(x.getId(), x.getDateTime(), x.getDescription(), x.getCalories(), sumCaloriesPerDay.get(x.getDateTime().toLocalDate()).getSum() > caloriesPerDay))
